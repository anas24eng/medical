          ...
          <v-container>
            <v-flex>
              <v-card class="ma-5 text-center mt-12" shaped elevation="10">
                ...
                <v-card-title class="layout justify-center">Anas Abd</v-card-title>
                <v-card-subtitle class="layout justify-center">25 year, Baghdad</v-card-subtitle>
                <v-list>
                  <v-list-item>
                  ...
                  <v-list-item class="mt-n5">
                    ...
                    <v-list-item-subtitle>175 cm</v-list-item-subtitle>
                    <v-list-item-subtitle>75 Kg</v-list-item-subtitle>
                  </v-list-item>
                </v-list>
              </v-card>
            </v-flex>
                ...
                <v-list two-line subheader>
                  <v-list-item>
                    ...
                    <v-list-item-content class="ml-n5">
                      <v-list-item-title>Dr.Ahmed Mustafa</v-list-item-title>
                      <v-list-item-subtitle>Alnoaman Hospital Medical</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                </v-list>
